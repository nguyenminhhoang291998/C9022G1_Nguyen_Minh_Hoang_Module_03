...
<div class="form-table">
    <form method="post" action="users?action=edit">
        <div class="row">
            ...
            <input class="col-md-8" name="id" value="${user.id}" readonly>
        </div>

        <div class="row">
            <p class="col-md-4">Name: </p>
            <input class="col-md-8" type="text" name="name" value="${user.name}">
        </div>

        <div class="row">
            <p class="col-md-4">Email: </p>
            <input class="col-md-8" type="text" name="email" value="${user.email}">
        </div>
        <div class="row">
            <p class="col-md-4">Country: </p>
            <input class="col-md-8" type="text" name="country" value="${user.country}">
        </div>
