...
select k.ma_khach_hang, k.ho_ten, count(k.ma_khach_hang) as 'số lần đặt'
from khach_hang k join hop_dong h join loai_khach l
on k.ma_khach_hang = h.ma_khach_hang and k.ma_loai_khach = l.ma_loai_khach
...
h.ngay_lam_hop_dong, h.ngay_ket_thuc, 
ifnull((d.chi_phi_thue + sum(hd.so_luong*dv.gia)),d.chi_phi_thue ) 
as "Tổng tiền"
from khach_hang k 
...
order by k.ma_khach_hang asc,h.ma_hop_dong desc;
